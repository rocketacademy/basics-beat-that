...
var main = function (input) {
  ...
  if (currentGameMode == "waiting for player 1 to choose dice order") {
    ...
    if (input == "1") {
      ...
      player1Choice[0] = player1Choice[0] + player1;
  ...
  if (currentGameMode == "waiting for player 2 to choose dice order") {
    ...
    if (input == "1") {
      ...
      player2Choice[0] = player2Choice[0] + player2;
    ...
    if (Number(player1Choice) > Number(player2Choice)) {
      ...
      return (
        "Player 1 won! <br> Click 'submit' to play the game again! <br>Player 1 score: " +
        player1Choice[0] +
        "<br>Player 2 score: " +
        player2Choice[0]
      );
      ...
      currentGameMode = "waiting for player 1 input";
      return (
        "Player 2 won! <br> Click 'submit' to play the game again! <br>Player 2 score: " +
        player2Choice[0] +
        "<br>Player 1 score: " +
        player1Choice[0]
      );
