...
var main = function (input) {
  //While loop to keep loop running if game not ended (game ends only in 'winningPage' game state)
  while (currentGameMode != "winningPage") {
...
// Self comment on code: seems rather repetitive, e.g. block 3 and 4 is similar to block 1 and 2

// Qns: Instead of refreshing the web page to restart the game, how can i refactor the code to repeat the game when submit button is pressed after the winnning page (would storing the whole game as a function and put the game function into the main function be a possible solution? attempted but seems like couldn't achieve a workable solution)
