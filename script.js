...
var rollDiceForPlayer = function () {
  ...
  console.log("Player rolls are " + currentPlayerRolls);
  return (
...
var getPlayerScore = function (input) {
  ...
  if (input == 1) {
    ...
    if (currentPlayer == 2) {
      return (
        ...
        playerScore +
        ". It is now time to compare scores!"
      );
    }
  }
  if (input == 2) {
    ...
    if (currentPlayer == 1) {
      return (
        "Your chosen value is " +
        playerScore +
        ". It is now It is now Player 2's turn!"
      );
    }
    if (currentPlayer == 2) {
      return (
  ...
  console.log("The players' score are" + allPlayersScore);
};

var comparePlayersScore = function () {
  console.log(allPlayersScore);
  if (allPlayersScore[0] > allPlayersScore[1]) {
    return "Player 1 wins! Refresh to play again.";
  }
  if (allPlayersScore[0] < allPlayersScore[1]) {
    return "Player 2 wins! Refresh to play again.";
  }
  if (allPlayersScore[0] == allPlayersScore[1]) {
