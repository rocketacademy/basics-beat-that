var main = function (input) {
  ...
  if (roundCounter == 3) {
    ...
    if (player1Choice > player2Choice) {
      player1Wins += 1;
      return `Player 2 chose ${player2Choice}. Player 1 chose ${player1Choice}<br><br>Player 1 wins!<br><br>Player 1 wins = ${player1Wins}<br>Player 2 wins = ${player2Wins}<br>Draws= ${draws}`;
    }
    if (player1Choice < player2Choice) {
      player2Wins += 1;
      return `Player 2 chose ${player2Choice}. Player 1 chose ${player1Choice}<br><br>Player 2 wins!<br><br>Player 1 wins = ${player1Wins}<br>Player 2 wins = ${player2Wins}<br>Draws= ${draws}`;
    }
    if (player1Choice == player2Choice) {
      draws += 1;
      return `Player 2 chose ${player2Choice}. Player 1 chose ${player1Choice}<br><br>It's a draw!<br><br>Player 1 wins = ${player1Wins}<br>Player 2 wins = ${player2Wins}<br>Draws= ${draws}`;
    }
  }
};
